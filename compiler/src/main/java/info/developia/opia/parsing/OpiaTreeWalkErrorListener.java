...
public class OpiaTreeWalkErrorListener extends BaseErrorListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(OpiaTreeWalkErrorListener.class);
